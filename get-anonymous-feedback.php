...
// Construct SQL query to select anonymous feedback details from dynamic feedback table
$feedbackTableName = str_replace(' ', '_', $orgName) . "_" . $orgId . "_fb";
$sql = "SELECT feedbackId, feedbackType, feedbackText, submissionTime FROM $feedbackTableName WHERE anonymity = 1";
...
?>
  ...
  <head>
    ...
    <title>Anonymous Feedback Details</title>
    <!-- Link to the external CSS file -->
    <link rel="stylesheet" href="./styles/feedback-table.css">
  </head>

  <body>
    <div class="title-text">Anonymous Feedback</div>
      ...
      <table class="feedback-table">
        ...
        <tbody id="feedback-details-body">
          ...
          if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='4'>No anonymous feedbacks found</td></tr>"; // Colspan set to 4 to span all columns
          }
          ?>
        </tbody>
      </table>
...
<?php
  ...
  echo json_encode(array("error" => "Error fetching anonymous feedback details: " . $conn->error));
}
