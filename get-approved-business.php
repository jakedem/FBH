...
// Fetch organization names with orgType = 'business' and approval_status = 'Approved' from the database
$sql = "SELECT orgId, orgName FROM organizations WHERE orgType = 'business' AND approval_status = 'Approved'";
...
if ($result !== false && $result->num_rows > 0) {
  ...
  echo "No organizations with orgType 'business' and 'Approved' status found";
}
